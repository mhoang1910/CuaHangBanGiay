 ...
 * @author MINH DUC
 */
public class FrQLLoai extends javax.swing.JFrame {
    ...
    public FrQLLoai() {
        ...
        addTable(this.ISerSP.getListLoai());
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        for (Loai l : this.ISerSP.getListLoai()) {
            if (l.getMa().equals(ma)) {
                Loai loai = new Loai();
                loai.setMa(ma);
                loai.setTen(ten);

                JOptionPane.showMessageDialog(this, this.ISerSP.updateLoai(loai));
                addTable(this.ISerSP.getListLoai());
                return;
            }
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        JOptionPane.showMessageDialog(this, this.ISerSP.themLoai(loai));
        addTable(this.ISerSP.getListLoai());
    ...
    private void tblLoaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLoaiMouseClicked
        ...
        String ma = this.tblLoai.getValueAt(row, 1).toString();
        String ten = this.tblLoai.getValueAt(row, 2).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrQLLoai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void addTable(List<Loai> list) {
        DefaultTableModel model = (DefaultTableModel) tblLoai.getModel();
        model.setRowCount(0);
        int i = 0;
        for (Loai loai : list) {
            i++;
            model.addRow(new Object[]{i, loai.getMa(), loai.getTen()});
        }
    }
}
